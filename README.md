...
## Table of Contents
  ...
  - [Block Operations](#account-control-operations)
    - [getBlock](#getBlock)
    - [getBlockInforamtion](#getBlockInforamtion)    
  - [Freezing Operations](#account-control-operations)
    - [setFreezing](#setFreezing)
    - [unFreezing](#unFreezing)
  - [Networking Operations](#account-control-operations)
